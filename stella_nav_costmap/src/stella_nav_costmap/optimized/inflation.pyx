...
def calc_inflation_as_image(
        np.ndarray[double, ndim=2] background_cells,
        np.ndarray[long, ndim=2] start_i,
        np.ndarray[long, ndim=2] min_i,
        np.ndarray[long, ndim=2] max_i,
        np.ndarray[long, ndim=2] start_j,
        np.ndarray[long, ndim=2] min_j,
        np.ndarray[long, ndim=2] max_j,
        mask_lethal,
        mask_distance,
        np.ndarray[double, ndim=2] distance_array,
        inflation_cost,
        radius_px,
        lethal_radius_px):
